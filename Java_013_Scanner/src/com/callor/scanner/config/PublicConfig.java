...
public class PublicConfig {
	 ...
	 * 원래는 이러한 변수, method를 정적변수, 정적method 라고 한다.
	 * 
	 * 프로젝트가 시작될 때 언제든지 사용할 수 있도록
	 * 미리 준비되는 도구들 사용할 때는 클래스명.변수, 클래스명.method()와
	 * 같이 직접 클래스 이름을 통하여 접근한다.
	 */
