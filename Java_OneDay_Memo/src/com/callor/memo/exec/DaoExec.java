...
public class DaoExec {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			System.out.println("3 : 작성된 메모 이름으로 찾기");
			System.out.println("4 : 메모 작성하기");
			System.out.println("5 : 작성된 메모 수정");
			System.out.println("6 : 작성된 메모 삭제");
			...
			else if(work.equals("3")) memoPlayService.findName();
			else if(work.equals("4")) memoPlayService.memoWrite();
			else if(work.equals("5")) memoPlayService.updateMemo();
			else if(work.equals("6")) memoPlayService.deleteMemo();
