...
public class ArrayA {
	...
	public static void main(String[] args) {
		...
		홍길동.stNum = "0001";
		홍길동.stName = "홍길동";
		홍길동.kor = (int) (Math.random() * 50) + 51;
		홍길동.eng = (int) (Math.random() * 50) + 51;
		홍길동.math = (int) (Math.random() * 50) + 51;

		이몽룡.stNum = "0002";
		이몽룡.stName = "이몽룡";
		이몽룡.kor = (int) (Math.random() * 50) + 51;
		이몽룡.eng = (int) (Math.random() * 50) + 51;
		이몽룡.math = (int) (Math.random() * 50) + 51;

		성춘향.stNum = "0003";
		성춘향.stName = "성춘향";
		성춘향.kor = (int) (Math.random() * 50) + 51;
		성춘향.eng = (int) (Math.random() * 50) + 51;
		성춘향.math = (int) (Math.random() * 50) + 51;
